...
export default function Skill() {
  ...
  const skills  = {
    technical: [
      { name: "Generative AI", prof: 70 },
      { name: "Machine Learning", prof: 70 },
      { name: "Python", prof: 90 },
      { name: "AI integration and automation", prof: 70 },
      { name: "React", prof: 90 },
      { name: "Javascript", prof: 90 },
      { name: "Nodejs", prof: 75 },
      { name: "Tailwind CSS", prof: 60 },
      { name: "Data Structures", prof: 50 },
      { name: "AWS", prof: 85 },
      { name: "Cloud", prof: 89 },
    ],
    soft: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div className="flex justify-center mb-12 space-x-4">
          <button
            ...
            className={`px-6 py-3  rounded-lg text-semibold text-lg transition-all duration-200transition-shadow transition-transform duration-200 hover:shadow-lg hover:-translate-y-1 bg-white rounded p-4 ${
              skill == "technical"
